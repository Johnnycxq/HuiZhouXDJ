...
public class AutoToolbar extends Toolbar {
    ...
    public AutoToolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray menuA = context.getTheme().obtainStyledAttributes(attrs, R.styleable.ActionBar,
                defStyleAttr, R.style.ThemeOverlay_AppCompat);
        int menuTextAppearance = menuA.getResourceId(R.styleable.AutoLayout_Layout_layout_auto_basewidth,
