...
public class QfgdztinfoAdapter extends RecyclerView.Adapter<QfgdztinfoAdapter.ViewHolder> {

    private LayoutInflater mLayoutInflater;
    private List<QfgdztlistBean.DataBean> datas;
    ...
    public QfgdztinfoAdapter(Context context, List<QfgdztlistBean.DataBean> data) {
    ...
    public List<QfgdztlistBean.DataBean> getDatas() {
        return datas;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tv_smmc.setText(datas.get(position).getGDZTMC());
    ...
    public interface OnChildItemClickListener {
        void onClick(QfgdztlistBean.DataBean dataBean);
    }
