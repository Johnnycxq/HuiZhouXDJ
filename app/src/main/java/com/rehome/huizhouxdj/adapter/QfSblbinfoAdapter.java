...
public class QfSblbinfoAdapter extends RecyclerView.Adapter<QfSblbinfoAdapter.ViewHolder> {

    private LayoutInflater mLayoutInflater;
    private List<QfsblistBean.DataBean> datas;
    ...
    public QfSblbinfoAdapter(Context context, List<QfsblistBean.DataBean> data) {
