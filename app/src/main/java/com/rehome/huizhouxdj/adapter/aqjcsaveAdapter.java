...
public class aqjcsaveAdapter extends BaseAdapter {

    private Context context;
    private List<Uploadaqjcsave> list;
    private CallBack mCallBack;

    public aqjcsaveAdapter(Context context, List<Uploadaqjcsave> list, CallBack mCallBack) {
