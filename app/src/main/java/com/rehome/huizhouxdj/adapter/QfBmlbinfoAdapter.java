...
public class QfBmlbinfoAdapter extends RecyclerView.Adapter<QfBmlbinfoAdapter.ViewHolder> {

    private LayoutInflater mLayoutInflater;
    private List<QfbmlistBean.DataBean> datas;
    ...
    public QfBmlbinfoAdapter(Context context, List<QfbmlistBean.DataBean> data) {
    ...
    public List<QfbmlistBean.DataBean> getDatas() {
        return datas;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tv_smmc.setText(datas.get(position).getBMMC());
    ...
    public interface OnChildItemClickListener {
        void onClick(QfbmlistBean.DataBean dataBean);
    }
