...
public class QfdjAdapter extends RecyclerView.Adapter<QfdjAdapter.ViewHolder> {

    private LayoutInflater mLayoutInflater;
    private List<QfdjBean.DataBean> datas;
    ...
    public QfdjAdapter(Context context, List<QfdjBean.DataBean> data) {
    ...
    public List<QfdjBean.DataBean> getDatas() {
        return datas;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tv_smmc.setText(datas.get(position).getDJMC());
    ...
    public interface OnChildItemClickListener {
        void onClick(QfdjBean.DataBean dataBean);
    }
