...
public class othersbAdapter extends BaseAdapter {

    private Context context;
    private List<Othersbsave> list;
    private CallBack mCallBack;

    public othersbAdapter(Context context, List<Othersbsave> list, CallBack mCallBack) {
