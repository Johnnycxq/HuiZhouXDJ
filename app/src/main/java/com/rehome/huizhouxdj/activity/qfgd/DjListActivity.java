...
import com.rehome.huizhouxdj.adapter.QfdjAdapter;
import com.rehome.huizhouxdj.bean.QfdjBean;
...
public class DjListActivity extends BaseActivity2 implements View.OnClickListener {
    @BindView(R.id.rlv)
    RecyclerView rlv;

    List<QfdjBean.DataBean> datas;

    private QfdjAdapter qfdjAdapter;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_left:
                ...
                break;
            case R.id.tv_right:
                for (QfdjBean.DataBean dataBean : qfdjAdapter.getDatas()) {
                    ...
                    if (dataBean.isSelected()) {
                        ...
                        bundle.putString("DJID", dataBean.getDJID());

                        bundle.putString("DJMC", dataBean.getDJMC());
    ...
    public int getLayoutId() {
        return R.layout.activity_djlist;
    }
        ...
        NohttpUtils.getInstance().add(this, 0, requset, new HttpListener<String>() {
            ...
            public void onSucceed(int what, Response<String> response) {
                try {
                    ...
                    QfdjBean qfdjBean = GsonUtils.GsonToBean(response.get(), QfdjBean.class);
                    datas.clear();
                    datas.addAll(qfdjBean.getData());
                    setAdapter();
    ...
    private void setAdapter() {
        qfdjAdapter = new QfdjAdapter(context, datas);

        rlv.setLayoutManager(new LinearLayoutManager(context));

        rlv.setAdapter(qfdjAdapter);

        qfdjAdapter.setOnChildItemClickListener(new QfdjAdapter.OnChildItemClickListener() {
            @Override
            public void onClick(QfdjBean.DataBean dataBean) {
//                showToast(dataBean.getBMID());
    ...
    private String createJson() {
        ...
        info.setAction("Q4GD_DJLIST_GET");
