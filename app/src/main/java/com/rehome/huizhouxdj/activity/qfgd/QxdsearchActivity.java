...
public class QxdsearchActivity extends BaseActivity2 implements View.OnClickListener {
    ...
    public int getLayoutId() {
        return R.layout.activity_qxgdcx;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_left:
                ...
                break;
            case R.id.tv_right:
                Intent intent = new Intent(QxdsearchActivity.this, QfpmgdListActivity.class);
    ...
    public void initData() {
        ...
        initToolbar("缺陷工单查询", "查询", this);

        ilSbmc.setTvContentOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(QxdsearchActivity.this, SblistActivity.class);
        ...
        ilGzzt.setTvContentOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(QxdsearchActivity.this, GdztActivity.class);
        ...
        ilGzyxj.setTvContentOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(QxdsearchActivity.this, DjListActivity.class);
        ...
        ilZrbm.setTvContentOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent3 = new Intent(QxdsearchActivity.this, BmListActivity.class);
