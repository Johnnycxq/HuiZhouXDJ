...
import com.rehome.huizhouxdj.adapter.XsjhqyWorkXsAdapter;
...
public class XscbqyWorkXsActivity extends BaseActivity {
    ...
    private XsjhqyWorkXsAdapter adapterXs;
    ...
    private void setAdapterXs() {

        if (adapterXs == null) {
            adapterXs = new XsjhqyWorkXsAdapter(context, qyds, isHis);
            View headView = View.inflate(context, R.layout.qy_work_xs_item, null);
            ...
            adapterXs.notifyDataSetChanged();
        }
    }
