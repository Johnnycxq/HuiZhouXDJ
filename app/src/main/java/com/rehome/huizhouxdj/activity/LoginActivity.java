        ...
        public void onSucceed(int what, Response<String> response) {
            ...
            if (userInfo != null) {
                ...
                if (status.equals("0")) {
                    ...
                    SPUtils.put(LoginActivity.this, Contans.WIFI_4G, rb1.isChecked());
                    SPUtils.put(LoginActivity.this, "save", savePwUser.isChecked());
                    SPUtils.put(LoginActivity.this, Contans.USERNAME, etUse.getText().toString());
                    SPUtils.put(LoginActivity.this, "pwd", etPwd.getText().toString());
